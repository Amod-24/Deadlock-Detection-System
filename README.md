...
8. The deadlock(graph, no_processes, no_vertices) is executed. It shows the paths taken to traverse the graph and shows the deadlocked processes in it.# Deadlock-Detection-System
